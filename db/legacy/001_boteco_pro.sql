-- ============================================================
-- LEGACY FILE: 001_boteco_pro.sql
-- Este script fazia parte da primeira versão do esquema multitenant
-- baseado no schema boteco_pro.  Foi mantido nesta pasta apenas
-- como referência histórica.  A estrutura atual usa o schema
-- "public" para dados globais e schemas isolados para cada boteco.
--
-- Conteúdo original preservado abaixo para consulta.
